...
$(document).ready(function()
{
	...
	var nType_GX = location.href.search(/gen_web/i) > 0 ? 1 : '';
	var dTurnImg = $('.TurnImg'+nType_GX);
	...
	function start_device_iPhone()
	{
		...
		else
		{
			...
			let e = nType_GX == 1 ? TouchStart : TouchStop;
			document.dispatchEvent(e);
			
			Loading == 1 ? dTurnImg.show() : dTurnImg.hide();
			console.log("直向");
		}
