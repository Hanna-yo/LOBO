$(document).ready(function()
{
	...
	function LoadingOne_Load(t,n = 0)
	{
		...
		if(nStage == 1)
		{
			...
			nImgOn = nImgOn > (aArrImg.length - 7) ? (aArrImg.length - 7) : nImgOn;
	...
	function device_logo(iWw,iWh,nn = 0)
	{
		...
		console.log('');
		console.log('load_iWw:'+load_iWw);
		console.log('load_iHh:'+load_iHh);
		console.log('iWw:'+iWw);
		console.log('iWh:'+iWh);
