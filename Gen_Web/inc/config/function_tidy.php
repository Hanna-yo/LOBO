<?php
function JWTencode($aData,$sKey, $alg = 'HS256')
{
	$aHeader = array('alg' => $alg,'typ' => 'JWT');
	// $sKey = '58169dca872eb0d06129756d18f89f13';
...
function TidySend($sUrlName,$aData)
{
	...
	$aTidyUrl = array(
		...
		'DemoLink'		=> array('/api/game/outside/demo/link','POST'),	#取得試玩遊戲連結
	...
	$sApiUrl = 'https://api.laksjd.net';
	$aData['client_id'] = '9b74ac1d';
	$sKey = '5ea2c5ac371baa98dade6df3d6240f34';

	if($nFormal == 1)
	{
		$sApiUrl = 'https://asia.h93r.com';
		$aData['client_id'] = 'bb968d0d';
		$sKey = '58169dca872eb0d06129756d18f89f13';
	}
	$sHttpheader = JWTencode($aData,$sKey);
...
function Tidy_amount_out($nGiid,$dAmount,$nGid,$sGtoken,$nAgentCode,$nCurrency)
{
	/*
	#餘額轉出
	# $dAmount 參數需已乘 100
...
function Tidy_amount_in($nGiid,$dAmount,$nGid,$sGtoken,$nAgentCode,$nCurrency)
{
	/*
	#餘額轉入
	# $dAmount 參數需已乘 100
