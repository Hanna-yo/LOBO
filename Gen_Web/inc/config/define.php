...
define('INTERNAL_URL','http://lebogame2.apgame001.com/Gen_Web/game/');			#內部測試導回網址
define('INTERNAL_JUMP_URL','https://lebogame2.apgame001.com/Gen_Web/game/guide.php');	#內部測試跳轉頁面(導向對應遊戲)
define('GEN_HALL_URL','https://lebogame2.apgame001.com/Gen_Web/game/hall/');			#遊戲大廳
define('GEN_Detail_URL','https://lebogame2.apgame001.com/Gen_Web/');					#除CQ9外查看帳務網址

#基本匯率
define('BasicExchange',		1);
...
$aGameAjaxResCode = array(
	...
	'game_running'	=> 7, #之前游戏局尚未结束
	'currency_error'	=> 8, #不支援此幣別
	'repeat_login'	=> 9, #重複登入
);
...
# API 帳務類型
$aGameRecordType = array(
	'TabelGeneral'	=> '1', #棋牌類 一般帳
	'TabelBattle'	=> '2', #棋牌類 對戰
);
?>